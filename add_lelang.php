...
<div class="container">
    <div class="facts col-md-8">
		<div class="hero-unit">
            ...
            <h3>Tambah Lelangan</h3><br>
            <div class="single_left_contact ">
                <form action="buat_lelang_proses.php" method="post" enctype="multipart/form-data">

                    <div class="form-group">
                        <h4>Nama Lelang : </h4><br>
                        <div class="input-group">
                            <input type="text" class="form-control" name="nama" id="focusedInput" style="font-size: 25px">             
                        </div>
                    ...
                    <div class="form-group">
                        <h4>Berat Padi : </h4><br>
                        <div class="input-group">
                            <input type="number" class="form-control" name="kuantitas" id="focusedInput" min="5" max="1000" required="" style="font-size: 25px">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="harga" id="focusedInput" onkeydown="return numbersonly(this, event);"  required="" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="6" placeholder="Penjelasan tambahan padi yang akan dilelang" name="deskripsi"></textarea>
                    </div>
                <tr>
                    <td colspan="3">
